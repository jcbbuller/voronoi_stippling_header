...
1. Look for the "dottedheader_" javascript files within the "assets" folder.
   <img src="https://github.com/your_image.png](https://github.com/jcbbuller/voronoi_stippling_header/readme_examples/readme_example_1.jpg" alt="Image showing the dottedheader javascript files in the folder" width="250"     height="auto" />
