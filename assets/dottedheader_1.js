...
{
  const image = await FileAttachment("jake1.png").image();
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["jake1.png", {url: new URL("../assets/images/dotted_img_1.png", import.meta.url), mimeType: "image/png", toString}]
  ]);
